...
mixer.music.play(-1)  # el -1 se repide cada que termine
...
# Puntaje
puntaje = 0
fuente = pygame.font.Font('./fonts/Drum N Bass 22.ttf', 32)
texto_x = 10
texto_y = 10

# Texto final del juego
fuente_final = pygame.font.Font('./fonts/Drum N Bass 22.ttf', 40)
